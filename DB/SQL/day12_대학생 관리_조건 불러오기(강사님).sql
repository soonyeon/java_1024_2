...
-- 2022년 1학기 컴퓨터 개론 수강하는 학생 이름과 학점을 조회
...
select st_name as '이름', '학생' as 직위 from student join mojor on mo_st_num = st_num
 ...
 -- 2022160001학생의 2022년 1학기 평균 학점을 조회
 -- A : 4.5, B : 3.5, C : 2.5, D : 1.5, F:0
 -- (4.5 * 3 + 1.5 * 3) / (3+3 => 18/6 => 3.0
 
 select avg(sc_total), co_st_num as 학번 from course 
	join score on co_num = sc_co_num
    join student on st_num = co_st_num
    where co_st_num like '2022160001' and st_semester like 1;
