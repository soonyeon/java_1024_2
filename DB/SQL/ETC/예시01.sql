-- 제품 카테고리에 가전, 의류, 식품, 취미용품, 애견용품을 추가하는 쿼리를작성하세요

insert into product_category(pc_name)
value('가전'),('의류'), ('식품'), ('취미용품'),('애견용품');


select * from product_category;

-- 가전, 50인치 tV, 50인치 tV 팜, 10대, 10000원
-- 가전, 100인치 tV, 50인치 tV 팜, 10대, 100000원
-- 가전, 무풍에어컨, 무풍 에어컨 팜, 30대, 200000원
...
insert into product(pr_title, pr_contents, pr_amount, pr_price, pr_pc_num)
	values('50TV', '50인치 tV 팜', 10, 10000, 1),
    ('100인치 tV', '50인치 tV 팜', 10, 100000, 1),
    ('무풍에어컨', '무풍 에어컨 팜', 30, 200000, 1),
    ('셔츠', '울용 셔츠팜', 15, 1000, 2),
...
/*
- insert values문: 추가라는 값들을 모두 알고 있는 경우
