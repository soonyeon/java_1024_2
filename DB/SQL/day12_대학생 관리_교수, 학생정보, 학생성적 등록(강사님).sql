...
-- 중간은 100, 기말은 80, 출석 100, 과제 90점이고, 비율은 중간 4, 기말 4, 출석1, 과제1로 
-- 성적이 계산되어 총점에 저장
-- 학점은 100이하 90이상 A, 90미난 80 이상 B, 80미만 70이상 C, 70미만 60이상 D, 나머지F
-- 수강 번호가 2번이고, 중간은 100, 기말은 80, 출석 100, 과제 90점
-- insert 전에 total 을 계산하기 위한 트리거
