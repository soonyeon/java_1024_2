...
public class StringEx01 {
	...
	public static void main(String[] args) {
		 ...
		 * StringBuffer클래스는 문자열의 값 수정할 수 있다
...
//		System.out.println("배열의 길이 : "+ arr.length());
		...
		/* indexOf(문자또는 문자열) : 해당 문자열 / 문자를 0번지 부터 탐색하여
			첫번째 로 만나는 문자열/ 문자의 시작 */
		System.out.println("e의 위치 : "+str.indexOf("e"));
		
		/* indexOf(문자또는 문자열) : 해당 문자열 / 문자를 마지막 부터 탐색하여
		 *첫번째 로 만나는 문자열/ 문자의 시작 번지
		 ...
		 * subStiring(시작번지, 마지막 번지) : 문자열의 시작번지부터 마지막 번지( -1)까지 부분 문자열을 추츨
		 */
		 ...
		 * 문자열은 참조변수이기 때문에  ==를 통해서 정확히 같은지 다른지를 바교할 수 없다.
		 * 리터럴 문자열은 리터럴들만 모여있는 공강에 할당이 되는데, 같은 리터럴 문자열이 있는 경우
		...
		System.out.println("str1 과 str2 가 같다?(==) : " + (str1 == str2));
		System.out.println("str1 과 str3 가 같다?(==) : " + (str1 == str3));
		System.out.println("str1 과 str2 가 같다?(equals) : " + (str1.equals(str3)));
		System.out.println("str1 과 str3 가 같다?(equals) : " + (str1.equals(str3)));
		...
		/* trim() : 시작문자 앞에있는 공백을 제거하고 마지막 문자 뒤에 있는 공백을 제거함
		 */  
		//\ = 엔터, \t = 탭만큼의 공백
		String str5 = "\n\n      \t안녕 하세요.\n\n";
