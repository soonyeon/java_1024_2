...
public class InheritanceEx02 {
	...
	public static void main(String[] args) {
		KiaCar kcar = new KiaCar(4, "K5",0xff0000,"134가 1234");
		kcar.powerOn();
		kcar.changeGear('D');
		for(int i = 0; i < 30; i++) {
			kcar.accelerator();	
		...
		HyundaiCar hcar = new HyundaiCar(4, "쏘나타",0xff0000,"135가 1234");
		hcar.powerOn();
		hcar.changeGear('D');
		for(int i = 0; i < 30; i++) {
			hcar.accelerator();	
...
//	전원 켜기/끄기, 기어 변경, 속력 업/다운
	...
	public void breaker() {
		...
		//speed = speed <= 0 ? 0 : speed - 1;  (위 3줄을 한줄로 표현한것(중괄호 포함 4줄))
	}
	public void print() {
