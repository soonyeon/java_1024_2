...
public class MethodBaseballGameEx01 {
	...
	public static void main(String[] args) {
		/* 1~9 사이의 중복되지 않은 3개의 숫자가 랜덤으로 생성이 되고,
		 * 생성된 숫자를 맞추는 게임
		 * 규칙
...
//		int[]user = new int[size];
	 ...
	 */
		...
		/**
		 * 기능: 두 배열이 주어지면 같은 번지에 있는 수를 비교하여 일치하는 숫자들이 몇개있는지
		 *     알려주는 메소드
		 *     
		 * @parm arr1 int[] : 첫번째 정수 배열
		 * @parm arr2 int[] : 두번째 정수 배열
...
//1. 램덤수 생성	
	...
	/** 
	 * 기능: 두 정수 배열이 주어지면 같은 숫자들 중에서 번지가 서로 다른
	 * 숫자들의 개수를 알려주는 메소드
	 * @return 
	 * @parm arr1 int[] : 첫번째 정수 배열
	 * @parm arr2 int[] : 두번째 정수 배열
