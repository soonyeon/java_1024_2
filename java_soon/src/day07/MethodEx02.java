...
public class MethodEx02 {
	 ...
	 */ 
	public static void printTimesTable1(int dan) {
		for(int i = 1; i<=9; i++) {
	 ...
	 */ 
	public static void printTimesTable2(int dan, int start, int end) {
	 ...
	 * 
	 */
	//public static 리턴타입 메소드명(매게변수들) {
		//구현;
		
	public static int multi(int dan, int i) {
		return dan * i;
	}
}
