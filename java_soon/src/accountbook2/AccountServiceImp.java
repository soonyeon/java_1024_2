...
//	
	...
	public void runMenu(ArrayList<Item> list, int menu, Scanner scan) throws ParseException {
		...
		case 2:
			...
			printItem(list, (s) -> s.getDateStr().substring(0,4).equls(""+year));
			break;
		case 3:
			...
			printItem(list, (s) -> s.getDateStr().substring(0,7).equls(""+year+"-"+month));
			break;
		case 4:
			//년 월 일을 입력(2022-11-16)
			...
			printItem(list, (s) -> s.getDateStr().substring(0,10).equls(""+year+"-"+month+"-"+day));
			break;
//		case 5:
